...
export const MOCK_JOBS: Job[] = [
  ...
  },
  {
    ...
    benefits: ['تأمين صحي', 'تدريب مكثف', 'فرص ترقية'],
  ...
  },
  {
    ...
    benefits: ['راتب أساسي + عمولات', 'بدل وقود', 'هاتف محمول', 'تأمين صحي'],
  ...
  },
  {
    ...
    benefits: ['تأمين صحي', 'بدل مواصلات', 'وجبات مجانية'],
  ...
  },
  {
    ...
    benefits: ['تأمين صحي', 'تدريب على خدمة العملاء', 'بيئة عمل ودية'],
