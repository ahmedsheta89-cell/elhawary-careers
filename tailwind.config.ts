 ...
 * Customized for El Hawary Careers - Healthcare Theme
 */
...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        arabic: ['IBM Plex Sans Arabic', 'Tajawal', 'Noto Sans Arabic', 'system-ui', 'sans-serif'],
